...
class CompanyInline(admin.StackedInline):
    ...
    fields = ('company_name', 'description', 'industries', 'other_industry', 
              'contact_email', 'contact_phone', 'subscription_status', 
              'subscription_start_date', 'subscription_end_date', 'is_verified')

class CustomUserAdmin(UserAdmin):
    inlines = (CompanyInline,)
    list_display = ('username', 'email', 'get_company_name', 'get_subscription_status', 'is_staff', 'date_joined')
...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ['company_name', 'user', 'subscription_status', 'is_verified', 'created_at']
